...
function carrosel(){
    var Carrosel = setInterval (()=>{
        ...
        imagemCorrente.setAttribute("src", "imagens do Carrosel/BURGER 1.jpg")
        ...
        if(numero == 0){
            ...
            imagemCorrente.setAttribute("src", "imagens do Carrosel/BURGER 2.jpg")
        }

        else if (numero == 2){
            imagemCorrente.setAttribute("src", "imagens do Carrosel/BURGER 3.jpg")
        }

        else if (numero == 3){
            imagemCorrente.setAttribute("src", "imagens do Carrosel/BURGER 4.jpg")
        }
        //Zerando o contador
        else if (numero > 3){
